...
| Category              | Problems                                |                                                             |                                                   |                                                     |                                                 |                                 |                                                         |                                                 |
|:----------------------|:----------------------------------------|:------------------------------------------------------------|:--------------------------------------------------|:----------------------------------------------------|:------------------------------------------------|:--------------------------------|:--------------------------------------------------------|:------------------------------------------------|
| [Tree DFS](#tree-dfs) | [All Traversals](#all-traversals)       | [Validate Binary Search Tree](#validate-binary-search-tree) | [Lowest Common Ancestor](#lowest-common-ancestor) |                                                     |                                                 |                                 |                                                         |                                                 |
| [Tree BFS](#tree-bfs) | [BTree Level Order](#btree-level-order) | [BTree Zigzag](#btree-zigzag)                               | [BTree Vertical Order](#btree-vertical-order)     | [BTree Average of Levels](#btree-average-of-levels) | [BTree Right Side View](#btree-right-side-view) | [BTree Cousins](#btree-cousins) | [BTree Next Right Pointers](#btree-next-right-pointers) | [BTree Check Symmetric](#btree-check-symmetric) |
